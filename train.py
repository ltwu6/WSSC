...
def main():
    ...
    if args.dataset == 'shapenet':
        train_set = data_load.ShapenetDataset(args.train_file, args.data_path)
        val_trained_set = data_load.ShapenetDataset(args.val_trained_file, args.data_path)
    elif args.dataset == 'scannet':
        train_set = data_load.ScannetDataset(args.train_file, args.data_path, use_bbox=True)
        val_trained_set = data_load.ScannetDataset(args.val_trained_file, args.data_path, use_bbox=True)
    else:
    ...
    model_refine = networks.PSLN(args.no_batchnorm, device, args.channel_num)
